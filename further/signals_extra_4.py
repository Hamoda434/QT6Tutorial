...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # SIGNAL: The connected function will be called whenever the window
        # title is changes. The new title is discarded in the lambda and the
        ...
        # SIGNAL: The connected function will be called whenever the window
        # title is changes. The new title is passed to the function
    ...
    #SLOT: This accepts a strong, e.g. the window title, and prints it
    def on_window_title_changed(self, s):
        print(s)

    #SLOT: This has default parameter and can be called without value
