...
from PySide6.QtWidgets import QApplication, QLabel, QMainWindow, QPushButton, QWidget, QVBoxLayout, QSpinBox
...
class Thread(QThread):
    ...
    def run(self):
        ...
        while True:
            ...
            self.result.emit(f"The cumulative count is {self.counter}")
            self.waiting_for_data = True

    def send_data(self, add, multiply):
        """
        Recieve data onto internal variable
        """
        self.input_add = add
